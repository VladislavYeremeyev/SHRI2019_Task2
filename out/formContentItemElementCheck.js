...
function checkContentItemElementRules(formContent, referenceSize) {
    const errors = [];
    const contentItemElements = utils_1.getInnerEntities(formContent, "form", "content-item");
    if (typeof contentItemElements !== "undefined") {
        contentItemElements.forEach((elem, i) => {
            ...
            if (typeof mixObj !== "undefined") {
                if (typeof utils_1.getModsError(mixObj, "indent-b", referenceSize, types_1.spaceValues, 1)
